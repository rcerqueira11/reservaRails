...
Usuario.create(nombre:'Guillermo', apellido:'del Toro', solvente:false, email:'nosolvente@gmail.com', propietario:false, edificio_id:2)
Usuario.create(nombre:'Amable', apellido:'Rivas', solvente:true, email:'co.prop@gmail.com', propietario:false, edificio_id:2)
